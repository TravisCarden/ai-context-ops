...
[`harnesses/`](harnesses/). Unsupported agents may be mentioned in [`meta/`](meta/) (roadmap,
...
## Where things live
See [`meta/STATUS.md`](meta/STATUS.md) for current state and [`meta/DECISIONS.md`](meta/DECISIONS.md) for why.
